...
use crate::{api::Client, context::Context};
...
pub fn HomeTemplate() -> impl IntoView {
    ...
    view! {
        ...
        <Body attr:class="text-zinc-400 min-h-screen w-full
...
fn NavigationLink(
    ...
    view! {
        <li class=move || { if &cur_page.get() == &link_copy { "font-bold" } else { "" } }>
            <a href=link.clone() on:click=move |_| { set_cur_page.set(link.to_string()) }>
                {name}
            </a>
        </li>
    }
    ...
    view! {
        <div class="lg:w-3/5 md:w-full text-black alegreya-sc-medium-italic">
            ...
            <form class="max-w-sm mx-auto mt-14">
                ...
                <div class="mb-3">
                    <button class="".to_owned() + COMMON_BUTTON_CLASS>Register</button>
                </div>
        ...
        <div class="lg:w-3/5 md:w-full text-black alegreya-sc-medium-italic">
            ...
            >
                <a href="/game" on:click=move |_| set_player_state.update(|ctx| ctx.in_game = true)>
                    "Welcome to the realm of Vallheru for the "
                    {move || crate::utils::to_ordinal(login_count.get() as u32)}
                    " time"
                    <br />
            ...
            <div class:hidden=move || logged_in_show.get()>
                ...
                <p class="text-lg text-center mt-8">
                    "Step into a world of imagination and adventure. Log in to continue your journey!"
                </p>
                ...
                <form on:submit=login_submit class="max-w-sm mx-auto mt-10">
                    <div class="mb-8 ".to_owned() + COMMON_FORM_CLASS>
                        <label for="login-email" class="text-black pr-3">
                            Email:
                        </label>
                        <input
                            type="email"
                    ...
                    <div class="mb-12 ".to_owned() + COMMON_FORM_CLASS>
                        <label for="login-password" class="text-black pr-3">
                            Password:
                        </label>
                        <input
                            type="password"
...
fn Rules() -> impl IntoView {
    view! { <p class="text-xl">Rules</p> }
}

#[component]
fn Faq() -> impl IntoView {
    view! { <p class="text-xl">FAQ</p> }
}

#[component]
fn Links() -> impl IntoView {
    view! { <p class="text-xl">Links</p> }
}
        ...
        <div class="lg:w-3/5 md:w-full text-black alegreya-sc-medium-italic">
            ...
            <div class="mb-8">
                ...
                <p class="text-justify">
                    ...
                    eros ultricies tincidunt." <br /><br />
